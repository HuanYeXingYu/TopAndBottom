package com.nzsc.myapplication.View;
...
public class TopBar extends LinearLayout {
    ...
    public void setLeftButtonVisibility(boolean flag) {
        if (flag) leftButton.setVisibility(View.VISIBLE);
        else leftButton.setVisibility(View.GONE);
    } //设置右边按钮的可见性
    ...
    public TopBar(Context context, final AttributeSet attrs) {
        super(context, attrs);
